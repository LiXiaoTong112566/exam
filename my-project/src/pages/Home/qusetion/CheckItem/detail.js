    ...
    <div>
      ...
      {props.detailConDataL &&
        props.detailConDataL.map((item, index) => {
          return (
            <div key={index} className={detailStyle.bottom}>
              <div className={detailStyle.left}>
                <p>出题人:dingshaoshan</p>
                <p>题目信息</p>
                <div className="color">
                  <span className={detailStyle.content_every_cont_left_left_y}>
                    {item.user_name}
                  </span>
                  <span
                    className={detailStyle.content_every_cont_left_center_y}
                  >
                    {item.subject_text}
                  </span>
                  <span className={detailStyle.content_every_cont_left_right_y}>
